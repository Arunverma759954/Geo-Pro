...
export default function ServicesPage() {
  return (
    <div className="mx-auto flex max-w-[1440px] flex-col gap-10 px-4 py-8 sm:gap-12 sm:px-6 sm:py-12 md:gap-16 md:px-10 md:py-20">
      {/* Services hero */}
      <section className="grid gap-6 sm:gap-8 md:grid-cols-[1.4fr_minmax(0,1fr)] md:gap-10 md:items-center">
        <div className="min-w-0 space-y-5">
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            <button className="rounded-full bg-red-700 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800">
              Explore solutions
            </button>
            <button className="text-sm font-semibold text-red-800 underline-offset-4 hover:underline">
