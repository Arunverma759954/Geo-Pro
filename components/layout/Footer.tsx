      ...
      <div className="relative z-10 mx-auto max-w-[1700px] px-6 py-12 md:px-12 md:py-20">
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex items-center gap-3">
              {[
                { name: "LinkedIn", href: "#", icon: "M6.09 5.5A2.09 2.09 0 1 1 2 5.5a2.09 2.09 0 0 1 4.09 0ZM2.32 8.32h3.53V21H2.32V8.32Zm6.34 0h3.38v1.72h.05c.47-.9 1.63-1.86 3.36-1.86 3.6 0 4.26 2.37 4.26 5.45V21h-3.53v-5.8c0-1.38-.02-3.15-1.92-3.15-1.93 0-2.23 1.5-2.23 3.05V21H8.66V8.32Z" },
                { name: "Twitter", href: "#", icon: "M18.25 3H21l-6.11 7.02L21.5 21h-4.5l-3.53-5.17L8.4 21H5.65l6.52-7.5L3.5 3h4.62l3.18 4.64L18.25 3Zm-1.58 15.25h1.25L7.4 4.68H6.05l10.62 13.57Z" },
        ...
        <div className="mt-20 flex flex-col items-center justify-between gap-6 border-t border-white/5 pt-10 md:flex-row">
          ...
          <div className="flex items-center gap-6">
            <p className="text-[10px] font-black uppercase tracking-widest text-[#c40902] italic">
