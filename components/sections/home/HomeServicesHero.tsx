        ...
        <div className="grid gap-8 md:grid-cols-[2fr_1fr] md:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4">
              <Link
                href="/services"
                className="rounded-full bg-[#16a34a] px-8 py-3.5 text-sm font-black text-white transition-all hover:bg-[#166534] hover:shadow-[0_0_25px_rgba(22,163,74,0.4)] hover:scale-105 cursor-pointer"
              >
                Explore solutions
              </Link>
              <Link
                href="/services"
                className="text-sm font-black text-slate-900 underline decoration-[#16a34a]/50 underline-offset-8 transition-all hover:decoration-[#16a34a]"
              >
