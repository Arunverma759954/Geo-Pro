...
export default function HomeServicesHero() {
  return (
    <section className="rounded-2xl border border-emerald-100 bg-emerald-50/60 px-4 py-6 shadow-sm sm:rounded-3xl sm:px-6 sm:py-8 md:px-10 md:py-10">
      <div className="grid gap-4 sm:gap-6 md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] md:items-center">
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <Link
              href="/services"
              className="rounded-full bg-red-700 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800"
            >
              Explore solutions
            </Link>
            <Link
              href="/services"
              className="text-sm font-semibold text-red-900 underline-offset-4 hover:underline"
            >
